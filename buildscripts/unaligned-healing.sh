...
MINIO_OLD=( "$PWD/minio.RELEASE.2021-10-02T16-31-05Z" --config-dir "$MINIO_CONFIG_DIR" server )
MINIO=( "$PWD/minio" --config-dir "$MINIO_CONFIG_DIR" server )

function download_old_release() {
    if [ ! -f minio.RELEASE.2021-10-02T16-31-05Z ]; then
	curl --silent -O https://dl.minio.io/server/minio/release/linux-amd64/archive/minio.RELEASE.2021-10-02T16-31-05Z
	chmod a+x minio.RELEASE.2021-10-02T16-31-05Z
    fi
}
